...
internal class LearningUnitPracticeIntegrationTest {
    ...
    fun existingLearnerTraversesTheExpansionWithLiveParentProgressAndDurableIdentities() =
        runUnitPracticeTest {
            ...
            assertEquals(listOf(5, 3, 5, 3, 2, 4, 4), units.drop(1).map { it.lessons.size })
            ...
            // 29 `android_ui` Lessons plus 29 in the coroutines and Flow Units, less the
            // one that was just un-studied.
            assertEquals(57, rebuilt.getStudiedLessons().size)
